...
import com.sakuya.search.data.wenku8.Wenku8ChapterIndexDto
import com.sakuya.search.data.wenku8.Wenku8NovelDto
 ...
 */
data class Wenku8DetailUiState(val novel: Wenku8NovelDto? = null, val index: Wenku8ChapterIndexDto? = null, val loading: Boolean = true, val error: String? = null)
